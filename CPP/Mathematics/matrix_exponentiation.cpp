 ...
 * 
 * Note : Same concept can be applied to transformations.
 * Example : p1=(x1,y1) - transforming p1 by relation (x+y,2y-x) for 100 times, 
 * is same as A^100 multiplied with matrix P where A= [ 1  1] and P=[x1]
 *                                                    [-1  2]       [y1]
 * 
 */

//Time Complexity & Space Complexity - (Size of Matrix)^3 x log n
#include<bits/stdc++.h>
#define mp make_pair
#define ll long long
using namespace std;
